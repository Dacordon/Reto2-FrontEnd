    ...
    for (let index = 0; index < items.length; index++) {
        ...
        tabla +=`<tr>
                  <td>${items[index].reference}</td>
                   ...
                   <td><button onclick="editarRegistro('${items[index].reference}')" class="btn btn-info">Editar</button></td>
                   <td><button onclick="mostrarEliminar('${items[index].reference}','${texto}')"class="btn btn-danger">Borrar</button></td>
                    </td>
                   </tr>`;     
    }
